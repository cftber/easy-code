 ...
 */
package com.tgzhao.easy.code.common.hystrix.basic;
...
import com.tgzhao.easy.code.common.hystrix.basic.ObservableCommandNumbersToWords.NumberWord;
...
public class ObservableCollapserGetWordForNumber extends HystrixObservableCollapser<Integer, ObservableCommandNumbersToWords.NumberWord, String, Integer>
{
	...
	public static class ObservableCollapserGetWordForNumberTest
	{
		...
		public void shouldCollapseRequestsSync()
		{
			...
			System.out.println("main test thread name-----" + Thread.currentThread().getName());
